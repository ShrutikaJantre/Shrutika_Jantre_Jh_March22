...
Sample input and  output 1: Enter an integer: 12 The square value is 144 The work has been done successfully Sample input 
and output 2: Enter an integer: Java Entered input is not a valid format for an integer. */
import java.util.*;
class Q1{
	...
	public static void main(String[] args){
		...
		try{
			...
			squareOfNumber = i*i;
			System.out.println("Square of "+i+" = " +squareOfNumber);
